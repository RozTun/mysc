...
TIMES="10"
CHATID="5881666389"
KEY="7002905823:AAFyV9ay0xNhaysgf7Wdrzl8Mt-Hx4GWgG0"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/RozTun/mysc/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $3}')
