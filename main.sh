...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $ipsaya | awk '{print $3}')
