...
clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To HUNTER-TUNNEL Script Installer ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Auther : ${green}HUNTER ${NC}${YELLOW}(${NC} ${green}RHT ${NC}${YELLOW})${NC}"
echo -e "       © Recode By RozTun ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
echo -e  "${green}┌──────────────────────────────────────────┐${NC}"
...
function key2(){
    ...
    if [[ $key == "1" ]]; then
        ...
        cd
        git clone https://github.com/RozTun/permision >/dev/null 2>&1
		cd izin
...
git clone https://github.com/RozTun/permision >/dev/null 2>&1
cd izin
sed -i "/# ADMIN/a ### ${author3} ${hhari3} ${MYIP3} ON 999" /root/izin/ip
...
echo -e "${green}└──────────────────────────────────────────┘${NC}"
echo -e "${green}┌──────────────────────────────────────────┐${NC}"
echo -e "${green}│  [ 1 ]  \033[1;37mDomain xxx.newbie-store.my.id          ${NC}"
echo -e "${green}│  [ 2 ]  \033[1;37mDomain xxx.vpnnewbie.my.id          ${NC}"
echo -e "${green}│  [ 3 ]  \033[1;37mDomain xxx.newbievpn.site          ${NC}"
echo -e "${green}│  [ 4 ]  \033[1;37mDomain xxx.nevpn.site          ${NC}"                                        
echo -e "${green}└──────────────────────────────────────────┘${NC}"
...
clear
echo -e  "${green}┌──────────────────────────────────────────┐${NC}"
echo -e  "${green}│  \033[1;37mContoh subdomain xxx.newbie-store.my.id        ${green}│${NC}"
...
"'&reply_markup={"inline_keyboard":[[{"text":"🔥ᴏʀᴅᴇʀ","url":"https://t.me/RozTun"},{"text":"🔥GRUP","url":"https://t.me/"}]]}'
