...
IPVPS=$(curl -sS https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
mkdir /root/casper
cd /root/casper
wget https://raw.githubusercontent.com/RozTun/permission/main/ipmini >/dev/null 2>&1
...
res1() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/RozTun/mysc1/main/install/r1.sh && chmod +x cr1.sh && ./per1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/RozTun/mysc1/main/install/c2.sh && chmod +x c2.sh && ./cr2.sh
clear
}
res4() {
wget https://raw.githubusercontent.com/RozTun/mysc1/main/install/r3.sh && chmod +x r3.sh && ./r3.sh
clear
}
clear
cd
...
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
echo -e "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "${tyblue}│  [ 1 ]  \033[1;37mDomain xxx.premm.my.id          ${NC}"                                        
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
...
clear
echo -e  "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e  "${tyblue}│  \033[1;37mContoh subdomain xxx.premm.my.id        ${tyblue}│${NC}"
...
clear
wget https://raw.githubusercontent.com/RozTun/mysc/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
"'&reply_markup={"inline_keyboard":[[{"text":"🔥 ORDER","url":"https://t.me/RozTun"},{"text":"🔥 TESTIMONI","url":"https://t.me/testirozstore"}]]}'
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/RozTun/mysc/main/versi  )
