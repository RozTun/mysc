...
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}01${WH}]${NC} ${COLOR1}• ${WH}ADD AKUN${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}02${WH}]${NC} ${COLOR1}• ${WH}TRIAL AKUN${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}03${WH}]${NC} ${COLOR1}• ${WH}RENEW AKUN${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}DELETE AKUN${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${WH}CEK USER LOGIN${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}06${WH}]${NC} ${COLOR1}• ${WH}CEK USER CONFIG${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}07${WH}]${NC} ${COLOR1}• ${WH}CHANGE USER LIMIT${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}08${WH}]${NC} ${COLOR1}• ${WH}SETTING LOCK LOGIN${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}09${WH}]${NC} ${COLOR1}• ${WH}UNLOCK USER LOGIN${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}10${WH}]${NC} ${COLOR1}• ${WH}UNLOCK USER QUOTA ${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}11${WH}]${NC} ${COLOR1}• ${WH}RESTORE AKUN   ${NC}"
echo -e " $COLOR1│ $NC${WH}[${COLOR1}00${WH}]${NC} ${COLOR1}• ${WH}GO BACK${NC}"              
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e " $COLOR1│${WH} ${WH}LIST TROJAN = ${COLOR1}$trtls ${WH}ACCOUNT $NC $COLOR1 $NC"
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e ""
