...
total_ssh=$(grep -c -E "^### " "/etc/xray/ssh")
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e " $COLOR1│${NC}${COLBG1}       ${WH}• SSH PANEL MENU •       ${NC}$COLOR1│"
echo -e " $COLOR1 •──────────────────────────────•${NC}"
...
echo -e " $COLOR1│ $NC${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${WH}CEK USER ONLINE${NC}"
...
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e " $COLOR1│${WH} ${WH}LIST SSH = ${COLOR1}$total_ssh ${WH}ACCOUNT $NC $COLOR1 $NC"
echo -e " $COLOR1 •──────────────────────────────•${NC}"
echo -e ""
