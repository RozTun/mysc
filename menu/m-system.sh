...
sldns() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
}
res1() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/slowdns/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/slowdns/rmbl1.sh && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/slowdns/rmbl2.sh && chmod +x rmbl2.sh && ./rmbl2.sh
clear
}
res4() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/slowdns/rmbl3.sh && chmod +x rmbl3.sh && ./rmbl3.sh
clear
}
res5() {
wget https://raw.githubusercontent.com/RozTun/mysc/main/slowdns/rmbl4.sh && chmod +x rmbl4.sh && ./rmbl4.sh
clear
}
clear
echo -e "$COLOR1┌──────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└──────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌──────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│  [ 1 ]  \033[1;37mDomain xxx.premm.my.id       ${NC}"
echo -e "$COLOR1│  "
echo -e "$COLOR1│  [ 2 ]  \033[1;37mDomain xxx.sgpremium.my.id     ${NC}"
#echo -e "$COLOR1│  "
...
clear
echo -e  "$COLOR1┌──────────────────────────────────────────┐${NC}"
echo -e  "$COLOR1│  \033[1;37mContoh subdomain xxx.premm.my.id       $COLOR1│${NC}"
...
clear
echo -e  "$COLOR1┌──────────────────────────────────────────┐${NC}"
echo -e  "$COLOR1│  \033[1;37mContoh subdomain xxx.sgpremium.my.id      $COLOR1│${NC}"
echo -e  "$COLOR1│    \033[1;37mxxx jadi subdomain kamu               $COLOR1│${NC}"
echo -e  "$COLOR1└──────────────────────────────────────────┘${NC}"
echo " "
...
echo -e  "$COLOR1│             ${WH}TERIMA KASIH                 $COLOR1│${NC}"
echo -e  "$COLOR1│        ${WH}SUDAH MENGGUNAKAN SCRIPT          $COLOR1│${NC}"
echo -e  "$COLOR1│               ${WH}HUNTER                     $COLOR1│${NC}"
echo -e  "$COLOR1└──────────────────────────────────────────┘${NC}"
echo " "
...
echo -e " $COLOR1║${NC} ${WH}[${COLOR1}77${WH}]${NC} ${COLOR1}• ${WH}INSTALL UDP CUSTOM${WH}  ${WH}[${COLOR1}88${WH}]${NC} ${COLOR1}• ${WH}INSTALL SLOWDNS${WH}    $COLOR1║ $NC"
...
77 |77) clear ; wget https://raw.githubusercontent.com/RozTun/mysc/main/install/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh ; exit ;;
88 |88) clear ; wget https://raw.githubusercontent.com/RozTun/mysc/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh ; exit ;;
