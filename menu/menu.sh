...
rm -rf /root/rmbl
echo -e  "${COLOR1}┌──────────────────────────────────────────┐${NC}"
echo -e  "${COLOR1}│          PASWORD SCRIPT HUNTER-TUNNEL    │${NC}"
echo -e  "${COLOR1}└──────────────────────────────────────────┘${NC}"
echo " "
...
web=$(curl -sS  https://rht.my.id/ress | grep $kode | awk '{print $3}')
web2=$(curl -sS https://rht.my.id/ress | grep $kode | awk '{print $2}')
web3=$(curl -sS https://rht.my.id/ress | grep $kode | awk '{print $4}')
web4=$(curl -sS https://rht.my.id/ress | grep $kode | awk '{print $5}')
web5=$(curl -sS https://rht.my.id/ress | grep $kode | awk '{print $6}')
userscript=$(curl -sS https://pastebin.com/raw/cKP8w6Bp | awk '{print $1}')
emailscript=$(curl -sS https://pastebin.com/raw/cKP8w6Bp | awk '{print $2}')
tokenscript=$(curl -sS https://pastebin.com/raw/cKP8w6Bp | awk '{print $3}')
userkey=$(curl -sS https://pastebin.com/raw/cKP8w6Bp | awk '{print $1}')
emailkey=$(curl -sS https://pastebin.com/raw/cKP8w6Bp | awk '{print $2}')
tokenkey=$(curl -sS https://pastebin.com/raw/cKP8w6Bp | awk '{print $3}')
if [[ $kode == $web ]]; then
MYIP=$(curl -sS ipv4.icanhazip.com)
...
mkdir /etc/github
echo "" > /etc/github/api
echo "sitisitimasruroh75@gmail.com" > /etc/github/email
echo "hunter-tun" > /etc/github/username
m-ip
fi
}
