...
clear
LIST=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/license/main/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/license/main/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/license/main/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/license/main/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/RMBL-VIP/license/main/key | grep $kode | awk '{print $6}')
...
userscript=$(curl -sS https://pastebin.com/raw/u22hkCHC | awk '{print $1}')
emailscript=$(curl -sS https://pastebin.com/raw/u22hkCHC | awk '{print $2}')
tokenscript=$(curl -sS https://pastebin.com/raw/u22hkCHC | awk '{print $3}')
userkey=$(curl -sS https://pastebin.com/raw/u22hkCHC | awk '{print $1}')
emailkey=$(curl -sS https://pastebin.com/raw/u22hkCHC | awk '{print $2}')
tokenkey=$(curl -sS https://pastebin.com/raw/u22hkCHC | awk '{print $3}')
if [[ $kode == $web ]]; then
MYIP=$(curl -sS ipv4.icanhazip.com)
...
sleep 0.5
rm ipmini
wget https://raw.githubusercontent.com/RMBL-VIP/license/main/key >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
...
mkdir /etc/github
echo "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" > /etc/github/api
echo "tefagiwi@gmail.com" > /etc/github/email
echo "RMBL-VIP" > /etc/github/username
m-ip
fi
}
...
cd
rm -rf *
wget https://sfvt.serv00.net/vip/menu/install-up.sh &> /dev/null
