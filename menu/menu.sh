...
Name=$(curl -sS https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
web=$(curl -sS  https://roztun.my.id/scku/ress | grep $kode | awk '{print $3}')
web2=$(curl -sS https://roztun.my.id/scku/ress | grep $kode | awk '{print $2}')
web3=$(curl -sS https://roztun.my.id/scku/ress | grep $kode | awk '{print $4}')
web4=$(curl -sS https://roztun.my.id/scku/ress | grep $kode | awk '{print $5}')
web5=$(curl -sS https://roztun.my.id/scku/ress | grep $kode | awk '{print $6}')
userscript=$(curl -sS https://pastebin.com/raw/ABHhVMDw | awk '{print $1}')
emailscript=$(curl -sS https://pastebin.com/raw/ABHhVMDw | awk '{print $2}')
tokenscript=$(curl -sS https://pastebin.com/raw/ABHhVMDw | awk '{print $3}')
userkey=$(curl -sS https://pastebin.com/raw/ABHhVMDw | awk '{print $1}')
emailkey=$(curl -sS https://pastebin.com/raw/ABHhVMDw | awk '{print $2}')
tokenkey=$(curl -sS https://pastebin.com/raw/ABHhVMDw | awk '{print $3}')
if [[ $kode == $web ]]; then
MYIP=$(curl -sS ipv4.icanhazip.com)
...
madmin=$(curl -sS https://raw.githubusercontent.com/RozTun/permission/main/ipmini | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
mkdir /etc/github
echo "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" > /etc/github/api
echo "ajanggaul9@gmail.com" > /etc/github/email
echo "RozTun" > /etc/github/username
m-ip
fi
}
